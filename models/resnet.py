...
def ResNet34(num_classes, softmax_output):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes, softmax_output)


def ResNet50(num_classes, softmax_output):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes, softmax_output)


def ResNet101(num_classes, softmax_output):
    return ResNet(Bottleneck, [3, 4, 23, 3], num_classes, softmax_output)


def ResNet152(num_classes, softmax_output):
    return ResNet(Bottleneck, [3, 8, 36, 3], num_classes, softmax_output)
